...
const Footer = () => {
  ...
  <div className="space-y-4 max-w-4xl mx-auto">
    ...
    <div className="text-sm md:text-xl">
      <p>Email: <Link href="mailto:jennifer@drjenniferhahm.com" className="underline">serena@blakepsychology.com</Link></p>
    ...
    <div className="flex flex-wrap justify-center gap-4 text-sm md:text-xl">
      ...
      <Link href="/client-portal" className="hover:underline">Client Portal</Link>
    </div>
